      ...
      <div className="">
        <div className="grid grid-cols-3 gap-4">
          <div className="">
            <div className="flex-col">
              <div className="w-full flex flex-col  space-y-4 items-center">
                <p className="text-5xl font-semibold"> Register Account </p>
          ...
          <div className="...">
            <div className="flex-col">
              <div className="w-full flex flex-col space-y-4 items-center">
                <p className="text-5xl font-semibold"> Collect Tickets </p>
                <p className="text-3xl ">{points} points</p>
              </div>
            </div>
          </div>
          <div className="...">
            <div className="flex-col">
              <div className="w-full flex flex-col space-y-4 items-center">
                <p className="text-5xl font-semibold"> Refer a Friend </p>
                <p className="text-3xl ">{points} points</p>
              </div>
            </div>
          </div>
          <div className="">
            <div className="flex-col">
              <div className="w-full flex flex-col space-y-4 items-center">
                <p className="text-5xl font-semibold"> Follow on Twitter </p>
                <p className="text-3xl ">{points} points</p>
              </div>
            </div>
          </div>
          <div className="...">
            <div className="flex-col">
              <div className="w-full flex flex-col space-y-4  items-center">
                <p className="text-5xl font-semibold">Like/RT </p>
                <p className="text-3xl ">{points} points</p>
              </div>
            </div>
          </div>
